...
<div class="full-width-split group">
  <div class="full-width-split__one">
    <div class="full-width-split__inner">
      <h2 class="headline headline--small-plus t-center">Inkommande Fotbollsresor!</h2>
      ...
      <?php 
        ...
        <?php }
      ?>
      <p class="t-center no-margin"><a href="<?php echo site_url('travel-soccer') ?>" class="btn btn--blue">Alla Fotbollsresor</a></p>
    </div>
  </div>
...
<div class="full-width-split__two">
  <div class="full-width-split__inner">
    <h2 class="headline headline--small-plus t-center">Nya Fotbollsresor!</h2>
    ...
    ?>
    <p class="t-center no-margin"><a href="<?php echo site_url('travel-soccer') ?>" class="btn btn--yellow">Alla Fotbollsresor</a></p>
  </div>
</div>
