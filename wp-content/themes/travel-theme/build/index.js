...
class Search {
  ...
  openOverlay() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").addClass("body-no-scroll"); // Make text disappear when closing search field

    this.searchField.val(''); // puts cursor on search field when opened
